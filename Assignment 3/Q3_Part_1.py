...
def save_to_CSV():
    if not os.path.exists(home_path+"\\Assignment 3\\Output\\Q3_Part_1"):
        os.makedirs(home_path+"\\Assignment 3\\Output\\Q3_Part_1")
    
    with open(home_path+'\\Assignment 3\\Output\\Q3_Part_1\\Q3_Part_1.csv', 'w') as myfile:
