...
def save_to_CSV():
    if not os.path.exists(home_path+"\\Assignment 3\\Output\\Q4_Part_1"):
        os.makedirs(home_path+"\\Assignment 3\\Output\\Q4_Part_1")
    
    with open(home_path+'\\Assignment 3\\Output\\Q4_Part_1\\Q4_Part_1.csv', 'w') as myfile:
